...
public class AppController {
	...
	Student s1 = new Student("2020ICT47","Trisha",23,"ICT",3.66);
	Student s2 = new Student("2020CS31","Nayanthara",24,"CS",3.80);
	Student s3 = new Student("2020ASB88","Hansika",23,"BIO Sceince",4.0);
	Student s4 = new Student("2020ICT56","Kaja Agarwal",21,"IT",3.59);
	Student s5 = new Student("2020ICT95","Priyanka Chopra",30,"AMC",3.25);
